...
from django.db.models import ForeignKey, ManyToManyField, ManyToManyRel, ManyToOneRel, Model, OneToOneField, OneToOneRel
from graphql import Undefined

from undine.dataclasses import RelatedFieldInfo

if TYPE_CHECKING:
    from undine.typing import GenericField, RelatedField
...
@cache
def parse_model_relation_info(*, model: type[Model]) -> dict[str, RelatedFieldInfo]:
    ...
    for field in model._meta.get_fields():
        ...
        if relation_type.is_forward:
            ...
            related_name = field.remote_field.get_accessor_name()  # type: ignore[union-attr]
        ...
        relation_info[field_name] = RelatedFieldInfo(
            ...
            model=related_model,  # type: ignore[arg-type]
        )
