...
from undine.utils.resolvers import function_field_resolver

__all__ = [
    "convert_entrypoint_ref_to_resolver",
]

from undine.utils.resolvers import MutationResolver
...
def load_deferred_converters() -> None:
    ...
    @convert_entrypoint_ref_to_resolver.register
    def _(ref: type[ModelGQLType], *, many: bool) -> GraphQLFieldResolver:
