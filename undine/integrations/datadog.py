...
class DatadogFullHook(DatadogHook):
    ...
    def on_execution(self) -> Generator[None, None, None]:
        self.skip_field_spans = undine_settings.DATADOG_SKIP_FIELD_SPANS_PREDICATE(self.context)
...
def no_traced_variables(context: LifecycleHookContext) -> dict[str, Any]:
    """Set as the `DATADOG_VARIABLES_CALLBACK` setting to attach no variables at all to traces."""
    return {}
