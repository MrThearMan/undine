...
FieldPermFunc: TypeAlias = Callable[[Annotated[Any, "Model"], GQLInfo, Annotated[Any, "value"]], None]
InputPermFunc: TypeAlias = Callable[[Annotated[Any, "Model"], GQLInfo, Annotated[Any, "value"]], None]
ValidatorFunc: TypeAlias = Callable[[Annotated[Any, "Model"], GQLInfo, Annotated[Any, "value"]], None]

OptimizerFunc: TypeAlias = Callable[[Annotated[Any, "Field"], "OptimizationData", GQLInfo], None]
FilterAliasesFunc: TypeAlias = Callable[[Annotated[Any, "Filter"], GQLInfo], dict[str, DjangoExpression]]
