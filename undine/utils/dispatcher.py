...
class TypeDispatcher(Generic[From, To]):
    ...
    a default implementation, and failing that, raise a KeyError.
    ...
    def register(self, func: Callable[[From], To]) -> Callable[[From], To]:
        ...
        registered as the imlplementation for all the types in the Union.
        """
    ...
    def _get_name(self) -> str:
        ...
        Only works if the TypeDispatcher initializer is called on the
