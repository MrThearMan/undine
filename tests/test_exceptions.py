...
@pytest.mark.parametrize(
    **parametrize_helper({
        BulkMutateNeedsImplementationError.__name__: UndineErrorParams(
        ...
        DirectiveLocationError.__name__: UndineErrorParams(
        ...
        DirectiveRepeatedError.__name__: UndineErrorParams(
        ...
        ExpressionMultipleOutputFieldError.__name__: UndineErrorParams(
        ...
        ExpressionNoOutputFieldError.__name__: UndineErrorParams(
        ...
        InterfaceFieldDoesNotExistError.__name__: UndineErrorParams(
        ...
        InterfaceFieldNodeIDError.__name__: UndineErrorParams(
        ...
        InterfaceFieldTypeMismatchError.__name__: UndineErrorParams(
        ...
        InvalidEntrypointMutationTypeError.__name__: UndineErrorParams(
        ...
        MissingCalculationReturnTypeError.__name__: UndineErrorParams(
        ...
        MissingDirectiveLocationsError.__name__: UndineErrorParams(
        ...
        ModelFieldNotARelationError.__name__: UndineErrorParams(
            cls=ModelFieldNotARelationError,
            args={"field": "foo", "model": Task},
            message="Field 'foo' is not a relation in model 'example_project.app.models.Task'.",
        ),
        ModelFieldNotARelationOfModelError.__name__: UndineErrorParams(
        ...
        MutateNeedsImplementationError.__name__: UndineErrorParams(
        ...
        NoFunctionParametersError.__name__: UndineErrorParams(
        ...
        RegistryMissingTypeError.__name__: UndineErrorParams(
            cls=RegistryMissingTypeError,
            args={"registry_name": "foo", "key": "bar"},
            message="'foo' doesn't contain an entry for 'bar'",
        ),
        UnexpectedDirectiveArgumentError.__name__: UndineErrorParams(
...
@pytest.mark.parametrize(
    **parametrize_helper({
        GraphQLAPQHashInvalidError.__name__: GQLErrorParams(
            cls=GraphQLAPQHashInvalidError,
            args={},
            message="Automated Persisted Query hash is invalid.",
            extensions={"error_code": "APQ_HASH_INVALID", "status_code": 400},
        ),
        GraphQLAPQHashMissingError.__name__: GQLErrorParams(
            cls=GraphQLAPQHashMissingError,
            args={},
        ...
        GraphQLAPQVersionNotSupportedError.__name__: GQLErrorParams(
            ...
            extensions={"error_code": "APQ_VERSION_NOT_SUPPORTED", "status_code": 400},
        ),
        GraphQLAsyncAtomicMutationNotSupportedError.__name__: GQLErrorParams(
        ...
        GraphQLAsyncNotSupportedError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseHTTPForMutationsNonPostRequestError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseMultipartMixedForMutationsNonPostRequestError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseSSEForMutationsNonPostRequestError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseSSEForQueriesError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseWebSocketsForMutationsError.__name__: GQLErrorParams(
        ...
        GraphQLCannotUseWebSocketsForQueriesError.__name__: GQLErrorParams(
        ...
        GraphQLDataLoaderDidNotReturnSortedSequenceError.__name__: GQLErrorParams(
        ...
        GraphQLDataLoaderPrimingError.__name__: GQLErrorParams(
        ...
        GraphQLDataLoaderWrongNumberOfValuesReturnedError.__name__: GQLErrorParams(
        ...
        GraphQLDuplicatePrimaryKeysError.__name__: GQLErrorParams(
        ...
        GraphQLDuplicateTypeError.__name__: GQLErrorParams(
        ...
        GraphQLInvalidOrderDataError.__name__: GQLErrorParams(
        ...
        GraphQLMissingCalculationArgumentError.__name__: GQLErrorParams(
        ...
        GraphQLMissingContentTypeError.__name__: GQLErrorParams(
        ...
        GraphQLMissingOperationsError.__name__: GQLErrorParams(
        ...
        GraphQLModelsNotFoundError.__name__: GQLErrorParams(
        ...
        GraphQLNodeIDFieldTypeError.__name__: GQLErrorParams(
        ...
        GraphQLNodeInterfaceMissingError.__name__: GQLErrorParams(
        ...
        GraphQLNodeInvalidGlobalIDError.__name__: GQLErrorParams(
        ...
        GraphQLNodeMissingIDFieldError.__name__: GQLErrorParams(
        ...
        GraphQLNodeObjectTypeMissingError.__name__: GQLErrorParams(
        ...
        GraphQLNodeQueryTypeMissingError.__name__: GQLErrorParams(
        ...
        GraphQLNodeTypeNotObjectTypeError.__name__: GQLErrorParams(
        ...
        GraphQLNoExecutionResultError.__name__: GQLErrorParams(
        ...
        GraphQLPermissionError.__name__: GQLErrorParams(
            cls=GraphQLPermissionError,
            args={},
            message="Permission denied.",
            extensions={"error_code": "PERMISSION_DENIED", "status_code": 403},
        ),
        GraphQLPersistedDocumentNotFoundError.__name__: GQLErrorParams(
        ...
        GraphQLPersistedDocumentsNotSupportedError.__name__: GQLErrorParams(
        ...
        GraphQLPrimaryKeysMissingError.__name__: GQLErrorParams(
        ...
        GraphQLRelationMultipleInstancesError.__name__: GQLErrorParams(
        ...
        GraphQLRelationNotNullableError.__name__: GQLErrorParams(
        ...
        GraphQLScalarConversionError.__name__: GQLErrorParams(
        ...
        GraphQLScalarInvalidValueError.__name__: GQLErrorParams(
        ...
        GraphQLScalarTypeNotSupportedError.__name__: GQLErrorParams(
        ...
        GraphQLSSEStreamAlreadyOpenError.__name__: GQLErrorParams(
        ...
        GraphQLSSEStreamNotFoundError.__name__: GQLErrorParams(
            cls=GraphQLSSEStreamNotFoundError,
            args={},
            message="Stream not found",
            extensions={"error_code": "SSE_STREAM_NOT_FOUND", "status_code": 404},
        ),
        GraphQLSSEStreamNotOpenError.__name__: GQLErrorParams(
        ...
        GraphQLSSEStreamTokenMissingError.__name__: GQLErrorParams(
        ...
        GraphQLSubscriptionNoEventStreamError.__name__: GQLErrorParams(
        ...
        GraphQLSubscriptionTimeoutError.__name__: GQLErrorParams(
        ...
        GraphQLTooManyFiltersError.__name__: GQLErrorParams(
        ...
        GraphQLTooManyOrdersError.__name__: GQLErrorParams(
        ...
        GraphQLTypedDictAnnotatedIncorrectMetadataError.__name__: GQLErrorParams(
        ...
        GraphQLUnionResolveTypeInvalidValueError.__name__: GQLErrorParams(
        ...
        GraphQLUnionResolveTypeModelNotFoundError.__name__: GQLErrorParams(
...
def test_graphql_error_group__located__nodes_already_set() -> None:
    ...
    # path was empty → set to ["field"]
    assert error.path == ["field"]
    # nodes was already set → NOT overwritten (570->567 branch)
    assert existing_node in error.nodes


def test_graphql_status_error__no_code() -> None:
    """Branch 498->501: code=None — error_code extension not set."""
    # GraphQLStatusError base class has code=None; instantiating directly skips line 499.
