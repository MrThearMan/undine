...
def test_filter__repr():
    ...
    assert repr(MyFilter.name) == f"<undine.filtering.Filter(ref={field}, lookup='exact')>"
...
def test_filter__function__repr():
    ...
    assert repr(MyFilter.in_the_past) == f"<undine.filtering.Filter(ref={MyFilter.in_the_past.ref}, lookup='exact')>"
...
def test_filter__function__attributes():
    ...
    assert MyFilter.in_the_past.match == "any"
