...
def test_query_type__permission_single():
    ...
    MyQueryType.__permissions_single__(instance=task, info=MockGQLInfo())
...
def test_query_type__resolve_one():
    ...
    resolver = QueryTypeSingleResolver(query_type=MyQueryType)
...
def test_query_type__resolve_many():
    ...
    resolver = QueryTypeManyResolver(query_type=MyQueryType)
