...
### out
main:14: error: Argument 1 to "permissions" of "Input" has incompatible type "Callable[[TaskCreateMutation], None]"; expected "Callable[[Any, GQLInfo[Any], Any], Awaitable[None] | None] | None"  [arg-type]
