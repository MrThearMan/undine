...
### out
main:16: error: Argument 1 to "visible" of "Field" has incompatible type "Callable[[TaskType], bool]"; expected "Callable[[Any, DjangoRequestProtocol[Any]], bool] | None"  [arg-type]
