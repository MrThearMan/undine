...
### out
main:15: error: Missing named argument "one" for "TestDirective"  [call-arg]
main:15: error: Missing named argument "three" for "TestDirective"  [call-arg]
main:15: error: Argument "two" to "TestDirective" has incompatible type "int"; expected "str"  [arg-type]
"""
