...
from typing import TYPE_CHECKING, Any, Iterable, Literal, Protocol, TypedDict, Unpack
...
async def sse_get_response(communicator: ApplicationCommunicator) -> dict[str, Any]:
