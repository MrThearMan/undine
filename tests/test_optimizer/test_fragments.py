...
def test_optimizer__fragment_spread(graphql, undine_settings):
...
@pytest.mark.django_db
def test_optimizer__fragment_spread__to_one_relation(graphql, undine_settings):
...
@pytest.mark.django_db
def test_optimizer__fragment_spread__to_many_relation(graphql, undine_settings):
...
@pytest.mark.django_db
def test_optimizer__fragment_spread__same_relation_in_multiple_fragments(graphql, undine_settings):
    class PersonType(QueryType, model=Person, auto=False):
        name = Field()
        email = Field()
...
# TODO: When unions are supported `def test_optimizer__inline_fragment(): ...`
