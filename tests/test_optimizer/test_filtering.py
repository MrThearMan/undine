...
from undine import Entrypoint, Field, Filter, FilterSet, QueryType, create_schema
...
def test_optimizer__filtering(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__many__match_any(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__many__match_all(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__distinct(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__distinct_missing(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__lookup_changes_input_type(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__q_value(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__q_value__negated(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__function(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
...
@pytest.mark.django_db
def test_optimizer__filtering__function__empty_filter_results(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
        @Filter
...
@pytest.mark.django_db
def test_optimizer__filtering__logical_operators(graphql, undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
        name_startswith = Filter("name", lookup="startswith")
...
def setup_optimizer__filtering__function__typed_dict(undine_settings):
    class TaskFilterSet(FilterSet, model=Task, auto=False):
        @Filter
...
@pytest.mark.django_db
def test_optimizer__filtering__function__typed_dict(graphql, undine_settings):
...
@pytest.mark.django_db
def test_optimizer__filtering__function__typed_dict__not_required(graphql, undine_settings):
    setup_optimizer__filtering__function__typed_dict(undine_settings)
...
@pytest.mark.django_db
def test_optimizer__filtering__calculated_field(graphql, undine_settings):
    ...
    class TaskType(QueryType, model=Task, auto=False, filterset=TaskFilterSet):
        ...
        calculated_number = Field(Calculated(Arguments, return_annotation=int))
