...
def test_to_camel_case_and_back(value: str) -> None:
    assert to_snake_case(to_camel_case(value)) == value


@given(strategies.from_regex(ALLOWED_NAME))
def test_to_pascal_case_and_back(value: str) -> None:
...
def test_camel_case_still_camel_case(value: str) -> None:
...
def test_comma_sep_str(values, result) -> None:
