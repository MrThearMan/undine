...
# EntrypointFunctionResolver - async and permission paths
...
# FieldFunctionResolver - async paths and permission branches
...
# ModelAttributeResolver - null/not-nullable + async paths
...
# ModelSingleRelatedFieldResolver - async paths
...
# ModelManyRelatedFieldResolver - async paths
...
# ModelGenericForeignKeyResolver - async paths
...
# QueryTypeSingleResolver - null nullable + async permission paths
...
# QueryTypeManyResolver - entrypoint permissions_func + async permission branches
...
# NestedQueryTypeSingleResolver - async paths
...
# NestedQueryTypeManyResolver - async paths
...
# UnionTypeResolver - entrypoint permissions_func and async run
...
# TypedDictFieldResolver and NamedTupleFieldResolver
...
# FieldFunctionResolver.set_kwargs - info_param only (no root_param)
...
# ModelAttributeResolver.run_async - nullable null
...
# ModelSingleRelatedFieldResolver - __call__ async dispatch + non-nullable null async
...
# ModelManyRelatedFieldResolver - __call__ async dispatch
...
# ModelManyRelatedFieldResolver.check_permissions - no permissions_func branch (366->exit)
...
# ModelGenericForeignKeyResolver - __call__ async dispatch
...
# QueryTypeSingleResolver - async permissions_func (async coroutine)
...
# NestedQueryTypeSingleResolver - __call__ async dispatch + non-nullable null async
...
# NestedQueryTypeManyResolver - __call__ async dispatch
...
# NodeResolver - GraphQLNodeTypeNotObjectTypeError + GraphQLNodeIDFieldTypeError
...
# ConnectionResolver - __call__ async dispatch + check_permissions with permissions_func
# + check_permissions_async branches
...
# NestedConnectionResolver - __call__ async dispatch + check_permissions_async branches
...
# UnionTypeResolver - __call__ async dispatch + filter_results.none in async
...
# UnionTypeResolver.filter_union - early return when none=True
...
# UnionTypeResolver.fetch_instances - with limit
...
# UnionTypeResolver.fetch_instances_async - filter, order, limit branches
...
# UnionTypeConnectionResolver - filter_union and order_union branches
# (lines 1055, 1059, 1061, 1062->1065, 1080, 1081->1084)
...
# UnionTypeConnectionResolver - __call__ async dispatch + run_sync empty_connection
# + fetch_instances filter/order + fetch_instances_async filter/order
# + check_permissions with permissions_func
...
# UnionTypeConnectionResolver.filter_union (second class - lines 1296, 1300, 1302, 1303->1306)
# UnionTypeConnectionResolver.order_union (second class - lines 1321, 1322->1325)
...
# InterfaceTypeResolver - fetch_instances with limit + fetch_instances_async with limit
...
# InterfaceTypeConnectionResolver - run_sync + run_async + run_async empty_connection
# + optimize with filter/order kwargs
...
# Line 304: ModelSingleRelatedFieldResolver.run_sync - raise error when null and not nullable
...
# Line 366->exit: ModelManyRelatedFieldResolver.check_permissions - empty instances with permissions_func set
...
# Line 553: NestedQueryTypeSingleResolver.run_sync - raise error when null and not nullable
...
# Line 931: UnionTypeResolver.fetch_instances - return [] when filterset.none=True (sync)
...
# Lines 975->978: UnionTypeResolver.fetch_instances_async - False branch of filter_results.none
# (filterset exists, none=False, continue to orderset check)
...
# Lines 1059, 1061, 1062->1065: UnionTypeResolver.filter_union - aliases, distinct, no filters
...
# Lines 1080, 1081->1084: UnionTypeResolver.order_union - aliases and order_by
...
# Line 1149: UnionTypeConnectionResolver.run_async - empty connection when queryset_map is empty
...
# Lines 1217->1220: UnionTypeConnectionResolver.fetch_instances_async - False branch of filter_results.none
# (filterset exists, none=False, continue to orderset check)
...
# Lines 1303->1306: UnionTypeConnectionResolver.filter_union - filters applied (False branch, no filters)
...
# Lines 1322->1325: UnionTypeConnectionResolver.order_union - order_by applied (False branch, no order_by)
...
# Line 1339: UnionTypeConnectionResolver.optimize - continue when not optimizations (empty compile result)
...
# Line 1410: InterfaceTypeResolver.__call__ - async dispatch
...
# Lines 1728, 1730: InterfaceTypeConnectionResolver.optimize - filter/order kwargs passed
# (needs non-empty optimizations so the loop body is not skipped)
