...
from undine.typing import ConnectionInitMessage, GraphQLWebSocketCloseCode, SubscribeMessage
...
class WebSocketContextManager:
    ...
    async def send(self, message: ClientMessage) -> None:
        ...
        try:
            ...
            raise WebSocketConnectionClosedError from error
    ...
    async def __aexit__(self, *args: object) -> None:
        ...
        # Cancel pending tasks in the consumer (close code doesn't matter)
        await self.consumer.disconnect(close_code=GraphQLWebSocketCloseCode.NORMAL_CLOSURE)
    ...
    async def _from_consumer(self, event: ASGISendEvent) -> None:
        """
        Event received from the consumer. Must set a response or send will wait forever.
